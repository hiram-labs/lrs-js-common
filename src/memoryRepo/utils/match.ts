...
const or =
  (conditions: Op[]): Op =>
  (actual) =>
    match(conditions[0])(actual) || (conditions.length > 1 ? or(conditions.slice(1))(actual) : false);

const and =
  (conditions: Op[]): Op =>
  (actual) =>
    match(conditions[0])(actual) && (conditions.length > 1 ? and(conditions.slice(1))(actual) : true);
...
const nor =
  (conditions: any[]): Op =>
  (actual) =>
    not(conditions[0])(actual) && (conditions.length > 1 ? nor(conditions.slice(1))(actual) : true);
